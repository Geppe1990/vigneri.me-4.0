...
//                                                             di Twitter, Pulsante “Pin it” e widget sociali di Pinterest e Shareaholic</h3>
//                                                         <p>Dati Personali: Cookie; Dati di utilizzo</p>
//                                                     </li>
//                                                 </ul>
//                                             </div>
...
//                                 automaticamente durante l'uso di questa Applicazione.<br /> Se non diversamente specificato, tutti i Dati
//                                 richiesti da questa Applicazione sono obbligatori. Se l’Utente rifiuta di comunicarli, potrebbe essere
//                                 impossibile per questa Applicazione fornire il Servizio. Nei casi in cui questa Applicazione indichi alcuni
//                                 Dati come facoltativi, gli Utenti sono liberi di astenersi dal comunicare tali Dati, senza che ciò abbia
//                                 alcuna conseguenza sulla disponibilità del Servizio o sulla sua operatività.<br /> Gli Utenti che dovessero
//                                 avere dubbi su quali Dati siano obbligatori, sono incoraggiati a contattare il Titolare.<br /> L’eventuale
//                                 utilizzo di Cookie - o di altri strumenti di tracciamento - da parte di questa Applicazione o dei titolari
//                                 dei servizi terzi utilizzati da questa Applicazione, ove non diversamente precisato, ha la finalità di
...
//                                 indicate. Oltre al Titolare, in alcuni casi, potrebbero avere accesso ai Dati altri soggetti coinvolti
...
//                                     pubblici poteri di cui è investito il Titolare;</li>
...
//                                 nel trattamento siano localizzate. Per ulteriori informazioni, contatta il Titolare.<br /> I Dati Personali
//                                 dell’Utente potrebbero essere trasferiti in un paese diverso da quello in cui l’Utente si trova. Per
//                                 ottenere ulteriori informazioni sul luogo del trattamento l’Utente può fare riferimento alla sezione
//                                 relativa ai dettagli sul trattamento dei Dati Personali.</p>
...
//                                 Titolare per proteggere i Dati.<br /><br /> L’Utente può verificare se abbia luogo uno dei trasferimenti appena
//                                 descritti esaminando la sezione di questo documento relativa ai dettagli sul trattamento di Dati Personali o
...
//                                 un’autorità.<br /><br /> Al termine del periodo di conservazione i Dati Personali saranno cancellati. Pertanto,
...
//                                 finalità: Commento dei contenuti, Contattare l'Utente, Protezione dallo SPAM, Heat mapping, Statistica,
//                                 Visualizzazione di contenuti da piattaforme esterne, Gestione contatti e invio di messaggi, Pubblicità,
//                                 Gestione dei pagamenti, Interazione con social network e piattaforme esterne, Gestione dei database di
//                                 Utenti, Gestione delle richieste di supporto e contatto, Monitoraggio dell'infrastruttura e Gestione dei
//                                 tag. </p>
...
//                                                 caso tra i Dati Personali rilasciati dall’Utente ci sia l’email, questa potrebbe essere
//                                                 utilizzata per inviare notifiche di commenti riguardanti lo stesso contenuto. Gli Utenti
//                                                 sono responsabili del contenuto dei propri commenti.<br /> Nel caso in cui sia installato un
//                                                 servizio di commenti fornito da soggetti terzi, è possibile che, anche nel caso in cui gli
...
//                                                     relative a questa Applicazione. L'indirizzo email dell'Utente potrebbe anche essere
//                                                     aggiunto a questa lista come risultato della registrazione a questa Applicazione o dopo
//                                                     aver effettuato un acquisto.</p>
//                                             </div>
...
//                                                 costruire profili privati che il Titolare può visualizzare ed utilizzare per migliorare
...
//                                                 senza essere in alcun modo trattati da questa Applicazione.<br /> Alcuni di questi servizi
...
//                                                 impostazioni privacy dell’Utente relative ad ogni social network.<br /> Questo tipo di
//                                                 servizio potrebbe comunque raccogliere dati sul traffico per le pagine dove il servizio è
//                                                 installato, anche quando gli Utenti non lo utilizzano.<br /> Si raccomanda di disconnettersi
...
//                                                     può mostrare widget appartenenti a terze parti, ad esempio i gestori dei social network
//                                                     su cui condividere le interazioni. In questo caso, anche le terze parti che erogano il
//                                                     widget verranno a conoscenza delle interazione effettuata e dei Dati di Utilizzo
...
//                                                 vengano utilizzati per questa finalità. Dati e condizioni di utilizzo sono indicati di
//                                                 seguito.<br /> Alcuni dei servizi di seguito indicati potrebbero utilizzare Cookie per
//                                                 identificare l’Utente o utilizzare la tecnica del behavioral retargeting, ossia visualizzare
//                                                 annunci pubblicitari personalizzati in base agli interessi e al comportamento dell’Utente,
...
//                                                     in maniera personale un individuo o identificare in modo permanente uno specifico
//                                                     dispositivo.<br /> L’estensione User ID permette inoltre di connettere Dati provenienti da
//                                                     Google Analytics con altri Dati relativi all’utente raccolti da questa Applicazione.<br />
//                                                     Il link di Opt Out fornito di seguito consente di disattivare il tracciamento per il
//                                                     dispositivo che stai utilizzando, ma non esclude ulteriori attività di tracciamento
//                                                     effettuate dal Titolare. Per disattivare anche queste ultime, contatta il titolare
...
//                                                     Google.<br /> Google potrebbe utilizzare i Dati Personali per contestualizzare e
...
//                                                     Facebook monitora le conversioni che possono essere attribuite alle inserzioni di
...
//                                     Dati Personali precedentemente espresso. </li>
...
//                                     richiederne l’aggiornamento o la correzione. </li>
...
//                                     dati personali competente o agire in sede giudiziale.</li>
//                             </ul>
...
//                             <p>Per necessità legate al funzionamento ed alla manutenzione, questa Applicazione e gli eventuali servizi terzi
...
//                             <p>Questa Applicazione non supporta le richieste “Do Not Track”.<br /> Per scoprire se gli eventuali servizi di
...
//                                 riferimento alla data di ultima modifica indicata in fondo.<br /><br />Qualora le modifiche interessino
...
//                                     <p>Sono le informazioni raccolte automaticamente attraverso questa Applicazione (anche da applicazioni
...
//                                         titolare di questa Applicazione.</p>
